    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" data-interval="9000">
        <div class="carousel-inner row w-10 mxauto" role="listbox">
            <div class="carousel-item carousel-item-first col-md-4 active">
                <img class="img-fluid mx-auto d-bloc" src="img/clientsImg/iumo1.png" alt="slide 1">
            </div>
            <div class="carousel-item col-md-4">
                <img class="img-fluid mx-auto d-block" src="img/clientsImg/EstarSeguros.png" alt="slide 2">
            </div>
            <div class="carousel-item col-md-4">
                <img class="img-fluid mx-auto d-block" src="img/clientsImg/logodigitel.png" alt="slide 3">
            </div>
            <div class="carousel-item col-md-4">
            ...
            <div class="carousel-item col-md-4">
                <img class="img-fluid mx-auto d-block" src="img/clientsImg/logodigitel.png" alt="slide 6">
            </div>
            <div class="carousel-item col-md-4">
                <img class="img-fluid mx-auto d-block" src="img/clientsImg/iumo1.png" alt="slide 7">
            </div>
            <div class="carousel-item col-md-4">
